...
- (void) addNoteByTitle: (NSString *)title andText: (NSString *)text {
    
    MKNote* note =
    [NSEntityDescription insertNewObjectForEntityForName:@"MKNote"
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "maxkalagur.DemoApp" in the application's documents directory.
